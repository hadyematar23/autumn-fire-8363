...
RSpec.describe Garden do
  ...
  describe "instance methods" do 
    it "returns a unique plants that take less than 100 days to harvest" do #test for US 3- tried to get it to return them in the opposite order but could not. must be a factor of playing around with their presentation 
    ...
    it "orders those plants by the number of times they appear in the garden's plots" do #test for extension
